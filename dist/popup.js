...
import { hostname, validHost, parseHost, ALL_SITES, YOUTUBE_SITES, MUSIC_SITES,               } from "./settings.js";
...
async function main()                {
  ...
  const pause10 = document.querySelector                   ("#pause10") ;
  const pause60 = document.querySelector                   ("#pause60") ;
  const exceptions = document.querySelector             ("#exceptions") ;
  const exceptionEmpty = document.querySelector             ("#exception-empty") ;
  const hostInput = document.querySelector                  ("#host-input") ;
  const addHost = document.querySelector                   ("#add-host") ;
