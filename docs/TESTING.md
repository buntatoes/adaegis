...
5. With cleanup off, enable only YouTube filtering. The prompt should be YouTube-only, not Music. Reload YouTube, then play a watch video: preroll ads should be stripped or Skip should fire when it appears. Open home, watch, and Shorts. Click from home to a video without a full reload; filtering should continue. Open search or a channel, then a video; the new video should still be filtered, including when the address has a trailing slash. Account pages must not keep those hooks.
